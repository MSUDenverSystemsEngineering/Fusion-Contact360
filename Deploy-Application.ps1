	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Get-ChildItem -Path "$envSystemDrive\Users" -Force | Where-Object {$_.PSIsContainer -eq $true} | ForEach-Object {
			...
			If ((Test-Path $FusionStartMenu) -eq $true) {
				Remove-Folder $FusionStartMenu
			}
			If ((Test-Path $FusionDesktopClickOnce) -eq $true) {
				Remove-File $FusionDesktopClickOnce
			}
		}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAbm3Nsx7I2xIcE
# +hjh00lky1LxL2VKmMXxFmXyvUzHTaCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIIKV
# N0KO+osEQEt6aqTWHoRet05DmJY8ajumarlhXA0AMA0GCSqGSIb3DQEBAQUABIIB
# AIkCSx8tU/LNKpKfQqHIqKwFEjX3/ttBGkMtxVALfV9OaoA9kfbpe7Fs/x1ZPQGV
# 7aQQCvN/R63AgVIoXLpKOyor0Se8rtUedeLL1sNeJNRFWtg1x2qjGRYltUnDJ3n6
# t+6s4fWdMSS9184WYt7+BcXwe6wscUaIu/VRiUcEfCjK0by7BHd8vHjoviOE7jhN
# FEpS1pSSkHif+7cth2tdbLAjLfC2bSykTbW/B6kkWay3HLwxvnLvEBPYBg1gRjUb
# A/+ON7jAJa9lNCbClxIuEA6VvNqAlDLQikkBQuxhe5ocau5S+AQvBfH84ksW4rvL
# whMCiCUDZi0AbpqYBquTNh+hggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwNjA1MjIyOTU4WjAjBgkqhkiG9w0BCQQxFgQU
# wBZXiNGDUFnHrPAu5Ptk3gZzFwEwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAEaz3e6NSycvJysF5qhFA0/UG8Esl83Cbgn04ivjlCckshIOJIOXGYr3
# NmzNSOOavYjEkR52P6u5/Co5lDLGKwDs6bibChlFZdz0mTYjeig+54tq1Zk7lNxM
# oCzfRx5X0YqjJfJdpVpyddysQc44t9Q+5KYSIccU9kZQSbu6Ts7BZY1hgNt+3ZO5
# J7MyseiULjAqmzw2+w837aWD6TlBTTi16F7AP4D0PYqRpEllKVDbqGW71ikC/OmS
# 6/Mlya29sybYOKCYXUL1A1lN4pQmmV95wUWpJq2tBLyzSGttfiI8QqD67JwjUvng
# j1DMEwxDG1NZw2VyV32HaDu3s6oN3eY=
